#!/usr/bin/env python3
"""`aplicaKernel` de ESTE experimento: su kernel 7x7, sin relleno.

    from aplica_kernel import aplicaKernel
    salida = aplicaKernel(imagen)        # (H,W) o (C,H,W) o (B,C,H,W) -> (1, H-7+1, W-7+1)
...
from preproceso import aplicaKernel_1k7 as aplicaKernel   # noqa: E402
