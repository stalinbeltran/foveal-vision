#!/usr/bin/env python3
"""Entrena la red de UN kernel SIN RELLENO reusando el bucle del repo, sin tocarlo.
...
RED = "plana-20-1k7"      # su propia config (channels [1]); el relleno lo quita el parche
RECETA = "plan40"
