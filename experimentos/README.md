...
| [`2026-09-03-cnn-plana-2k7-sinpadding/`](2026-09-03-cnn-plana-2k7-sinpadding/) | El 2k7 con `padding=0` de verdad: sin anillo porque no hay relleno. Salida 14×14 y cabeza de 392 features. **Código local**, sin tocar `src/fv/` |
