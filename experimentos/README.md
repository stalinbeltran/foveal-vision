...
| [`2026-09-04-preproceso-kernel-congelado/`](2026-09-04-preproceso-kernel-congelado/) | **Un experimento, TRES brazos**: la L1 ya entrenada de `1k3`/`1k5`/`1k7`, **congelada**, como preproceso de una plana nueva. ⚠ Va por la **época 3 de 37 y NO hay veredicto**: los tres van por delante de su ancla (+0,19 · +0,31 · sin ancla) y eso es **esperado por construcción** — su L1 no parte de ruido. En esta serie el orden a la ép. 3 sale **invertido** respecto al final, así que `comparativa.py` se niega a declarar antes de la 11 |
