#!/usr/bin/env python3
"""`aplicaKernel` de ESTE experimento: su kernel 5x5, sin relleno.

    from aplica_kernel import aplicaKernel
    salida = aplicaKernel(imagen)        # (H,W) o (C,H,W) o (B,C,H,W) -> (1, H-5+1, W-5+1)
...
from preproceso import aplicaKernel_1k5 as aplicaKernel   # noqa: E402
